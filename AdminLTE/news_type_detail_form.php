...
$titlePage = "รายละเอียดประเภทข่าว";
                        ...
                        <div class="row">
                                ...
                                <div class="card card-info">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nst_id" class="form-control" value="<?php echo $result["nst_id"]; ?>" disabled>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="card card-info">
                                    <div class="card-header">
                                        <i class="fa-solid fa-circle-info"></i>
                                        <span>รูปประเภทข่าว</span>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label class="form-label py-2" for="nst_img">รูปภาพประเภทข่าว : </label>
                                            <img class="rounded mx-auto d-block border" style="width:250px; height:150px" id="nst_img" name="nst_img" src="../uploads/img_news_type/<?php echo $result["nst_img"]; ?>">
                                        </div>
                                        <!-- <div class="form-group">
