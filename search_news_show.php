...
try {
    // เมื่อมีการกดปุ่ม ค้นหาสถานที่ท่องเที่ยว
    if (!empty($_GET['search'])) {
        ...
        $sql = "SELECT pbr_news.ns_id, 
                ...
                WHERE pbr_news.ns_title LIKE :search
                AND pbr_news.ns_status = 1 
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">ผลลัพธ์การค้นหา</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="index.php">หน้าหลัก</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">ผลลัพธ์การค้นหา</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3 mb-md-0">
                                        ...
                                        <?php } else { ?>
                                            <input type="text" name="search" value="<?php echo $search ?>" class="form-control px-4" style="height: 47px;" placeholder="ระบุ คำค้นหาข่าว ที่ต้องการ">
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row pb-3">
                        ...
                        <?php } else { ?>
                            <div class="alert alert-warning text-center w-100" role="alert">
                                <h4 class="alert-heading mt-2">ไม่พบข่าวที่ค้นหา!</h4>
                                <i class="fa-solid fa-magnifying-glass fa-5x my-5"></i>
                                <p>คำค้นหา : <?php echo $search; ?></p>
                                <p>ไม่พบข่าวที่คุณค้นหา ขออภัยในความไม่สะดวก</p>
                                <hr>
