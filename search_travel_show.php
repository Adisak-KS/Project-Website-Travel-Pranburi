...
$titlePage = "ผลค้นหาสถานที่ท่องเที่ยว";
...
try {
    ...
    if (!empty($_GET['search'])) {
        ...
        $sql = "SELECT pbr_travel.tv_id, 
                ...
                WHERE pbr_travel.tv_name LIKE :search 
                AND pbr_travel.tv_status = 1 
                    ...
                    <div class="row pb-3">
                        <?php if ($travels) { ?>
                            <div class="d-flex w-100 mb-4">
                                <h5>คำค้นหา : <span class="fst-italic"><?php echo $search; ?></span></h5>
                            </div>
                        ...
                        <?php } else { ?>
                            <div class="alert alert-warning text-center w-100" role="alert">
                                <h4 class="alert-heading mt-2">ไม่พบสถานที่ท่องเที่ยวที่ค้นหา!</h4>
                                <i class="fa-solid fa-magnifying-glass fa-5x my-5"></i>
                                <p>คำค้นหา : <?php echo $search; ?></p>
                                <p>ไม่พบสถานที่ท่องเที่ยวที่คุณค้นหา ขออภัยในความไม่สะดวก</p>
                                <hr>
